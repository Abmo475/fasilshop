    ...
    const navs = [
        {
            ...
            redirect: "https://www.fasilshop.com/communication-preferences/push",
        },
        {
            title: "Sell on Fasilshop",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.fasilshop.com/sell-online",
        },
        {
            title: "24x7 Customer Care",
            icon: <LiveHelpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.fasilshop.com/helpcentre",
        },
        {
            title: "Advertise",
            icon: <TrendingUpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://advertising.fasilshop.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.fasilshop.com/mobile-apps",
        },
    ]
