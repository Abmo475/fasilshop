...
const Products = () => {
    ...
    return (
        <>
            <MetaData title="All Products | Fasilshop" />
                            ...
                            <div className="flex flex-col gap-2 py-3 text-sm overflow-hidden">
                                ...
                                <div className="flex flex-col gap-2 border-b px-4">
                                    ...
                                    <div className="flex gap-3 items-center justify-between mb-2 min-w-full">
                                        <span className="flex-1 border px-4 py-1 rounded-sm text-gray-800 bg-gray-50">ETB {price[0].toLocaleString()}</span>
                                        <span className="font-medium text-gray-400">to</span>
                                        <span className="flex-1 border px-4 py-1 rounded-sm text-gray-800 bg-gray-50">ETB {price[1].toLocaleString()}</span>
                                    </div>
                                </div>
                                {/* price slider filter */}
