    ...
    return (
        <div className="hidden sm:flex flex-col gap-4 w-1/4 px-1">
            ...
            <div className="flex flex-col bg-white rounded-sm shadow">
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    <Link className="p-3 pl-14 hover:bg-blue-50 hover:text-primary-blue flex justify-between pr-6" to="/">Gift Cards <span className="font-medium text-primary-green">ETB 0</span></Link>
