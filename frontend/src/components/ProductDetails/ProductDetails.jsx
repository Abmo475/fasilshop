                            ...
                            <div className="w-full sm:w-2/5 sm:sticky top-16 sm:h-screen">
                                ...
                                <div className="flex flex-col gap-3 m-3">
                                    ...
                                    <div className="w-full flex gap-3">
                                        {/* <!-- add to cart btn --> */}
                                        {product.stock > 0 && (
                                            <button onClick={itemInCart ? goToCart : addToCartHandler} className="p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-blue rounded-sm shadow hover:shadow-lg">
                                                <ShoppingCartIcon />
                                                {itemInCart ? "GO TO CART" : "ADD TO CART"}
                                            </button>
                                        )}
                                        <button onClick={buyNow} disabled={product.stock < 1 ? true : false} className={product.stock < 1 ? "p-4 w-full flex items-center justify-center gap-2 text-white bg-blue-600 cursor-not-allowed rounded-sm shadow hover:shadow-lg" : "p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-blue rounded-sm shadow hover:shadow-lg"}>
                                            <FlashOnIcon />
                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <div className="flex items-baseline gap-2 text-3xl font-medium">
                                        <span className="text-gray-800">ETB {product.price?.toLocaleString()}</span>
                                        <span className="text-base text-gray-500 line-through">ETB {product.cuttedPrice?.toLocaleString()}</span>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between">
                                        ...
                                        <div className="flex gap-16 mt-4 mr-6 items-stretch text-sm">
                                            ...
                                            <ul className="flex flex-col gap-2">
                                                ...
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-primary-blue"><span sx={{ fontSize: "18px" }}>Birr</span></span> Cash on Delivery available</p>
                                                </li>
                                            </ul>
                                        </div>
                                        {/* <!-- services details --> */}
