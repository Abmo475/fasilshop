                ...
                <div className="flex flex-col sm:gap-5 w-full pr-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start pr-5 gap-1 sm:gap-0">
                        ...
                        <div className="flex flex-col sm:gap-2">
                            <p className="text-sm">Delivery by {getDeliveryDate()} | <span className="text-primary-green">Free</span> <span className="line-through">ETB {quantity * 40}</span></p>
                    ...
                    <div className="flex items-baseline gap-2 text-xl font-medium">
                        <span>ETB {(price * quantity).toLocaleString()}</span>
                        <span className="text-sm text-gray-500 line-through font-normal">ETB {(cuttedPrice * quantity).toLocaleString()}</span>
