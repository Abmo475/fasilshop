...
const EmployeeNewProduct = () => {
    ...
    return (
        <>
            <MetaData title="Admin: New Product | Fasilshop" />
            ...
            <form onSubmit={newProductSubmitHandler} encType="multipart/form-data" className="flex flex-col sm:flex-row bg-white rounded-lg shadow p-4" id="mainform">
                ...
                <div className="flex flex-col gap-3 m-2 sm:w-1/2">
                    ...
                    <div className="flex justify-between gap-4 items-start">
                        ...
                        <label className="rounded bg-blue-600 text-center cursor-pointer text-white py-2 px-2.5 shadow hover:shadow-lg">
                            <input
                                type="file"
                                name="logo"
                                accept="image/*"
                ...
                <div className="flex flex-col gap-2 m-2 sm:w-1/2">
                    ...
                    <div className="flex justify-end">
                        <input form="mainform" type="submit" className="bg-primary-blue uppercase w-1/3 p-3 text-white font-medium rounded shadow hover:shadow-lg cursor-pointer" value="Submit" />
                    </div>
...
export default EmployeeNewProduct;
