...
var sellerCode = "14501",
    successUrlReturn ="",// "http://localhost:4000", //"YOUR_SUCCESS_URL",
    ipnUrlReturn ="",// "http://localhost:4000/cart", //"YOUR_IPN_URL",
    cancelUrlReturn = "",//"http://localhost:4000/cart", 
    failureUrlReturn = "",//"http://localhost:4000/cart", //"YOUR_FAILURE_URL",
    pdtToken = "alNYPbfB4VYTuN",
    useSandbox = false,
    currency = "ETB";
...
console.log(checkoutItems)
  ...
  var totalItemsDeliveryFee = 0;
  var totalItemsDiscount = 0;
  var totalItemsHandlingFee = 0;
  var totalPrice = 0;
//  for(let element of checkoutItems){
//     totalPrice += element.UnitPrice * element.Quantity;
//   };
  var totalItemsTax1 =  totalPrice;
